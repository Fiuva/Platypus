...
function nuevoNumeroAzar2048(b00, b01, b02, b03, b10, b11, b12, b13, b20, b21, b22, b23, b30, b31, b32, b33) {
    var arr = [];
    if (b00.customId.split('_')[3] == '0') arr.push(b00)
    if (b01.customId.split('_')[3] == '0') arr.push(b01)
    if (b02.customId.split('_')[3] == '0') arr.push(b02)
    if (b03.customId.split('_')[3] == '0') arr.push(b03)
    if (b10.customId.split('_')[3] == '0') arr.push(b10)
    if (b11.customId.split('_')[3] == '0') arr.push(b11)
    if (b12.customId.split('_')[3] == '0') arr.push(b12)
    if (b13.customId.split('_')[3] == '0') arr.push(b13)
    if (b20.customId.split('_')[3] == '0') arr.push(b20)
    if (b21.customId.split('_')[3] == '0') arr.push(b21)
    if (b22.customId.split('_')[3] == '0') arr.push(b22)
    if (b23.customId.split('_')[3] == '0') arr.push(b23)
    if (b30.customId.split('_')[3] == '0') arr.push(b30)
    if (b31.customId.split('_')[3] == '0') arr.push(b31)
    if (b32.customId.split('_')[3] == '0') arr.push(b32)
    if (b33.customId.split('_')[3] == '0') arr.push(b33)
    var num = 2;
    if (Math.random() < 0.1) num = 4;
    setNumber2048(arr[Math.random() * arr.length << 0], num)
}
function setNumber2048(button, number, sumado = false) {
    var idNueva = button.customId.split('_')[0] + '_' + button.customId.split('_')[1] + '_' + button.customId.split('_')[2] + '_' + number.toString();
    button.setCustomId(idNueva)
    if (number != 0) {
        button.setLabel(number.toString())
        if (sumado) {
...
function deMover02del2048(b02, b03) {
    var v02 = parseInt(b02.customId.split('_')[3])
    var v03 = parseInt(b03.customId.split('_')[3])
    if (v02 != 0) {
        if (v03 == 0) {
            setNumber2048(b02, 0);
...
function deMover01del2048(b01, b02, b03) {
    var v01 = parseInt(b01.customId.split('_')[3])
    var v02 = parseInt(b02.customId.split('_')[3])
    var suma = 0;
    if (v01 != 0) {
        if (v02 == 0) {
...
function deMover00del2048(b00, b01, b02, b03) {
    var v00 = parseInt(b00.customId.split('_')[3])
    var v01 = parseInt(b01.customId.split('_')[3])
    var suma = 0;
    if (v00 != 0) {
        if (v01 == 0) {
...
function abMover20del2048(b20, b30) {
    var v20 = parseInt(b20.customId.split('_')[3])
    var v30 = parseInt(b30.customId.split('_')[3])
    if (v20 != 0) {
        if (v30 == 0) {
            setNumber2048(b20, 0);
...
function abMover10del2048(b10, b20, b30) {
    var v10 = parseInt(b10.customId.split('_')[3])
    var v20 = parseInt(b20.customId.split('_')[3])
    var suma = 0;
    if (v10 != 0) {
        if (v20 == 0) {
...
function quitarAzules(b00, b01, b02, b03, b10, b11, b12, b13, b20, b21, b22, b23, b30, b31, b32, b33) {
    if (b00.style == 'PRIMARY') setNumber2048(b00, b00.label)
    if (b01.style == 'PRIMARY') setNumber2048(b01, b01.label)
    if (b02.style == 'PRIMARY') setNumber2048(b02, b02.label)
    if (b03.style == 'PRIMARY') setNumber2048(b03, b03.label)
    if (b10.style == 'PRIMARY') setNumber2048(b10, b10.label)
    if (b11.style == 'PRIMARY') setNumber2048(b11, b11.label)
    if (b12.style == 'PRIMARY') setNumber2048(b12, b12.label)
    if (b13.style == 'PRIMARY') setNumber2048(b13, b13.label)
    if (b20.style == 'PRIMARY') setNumber2048(b20, b20.label)
    if (b21.style == 'PRIMARY') setNumber2048(b21, b21.label)
    if (b22.style == 'PRIMARY') setNumber2048(b22, b22.label)
    if (b23.style == 'PRIMARY') setNumber2048(b23, b23.label)
    if (b30.style == 'PRIMARY') setNumber2048(b30, b30.label)
    if (b31.style == 'PRIMARY') setNumber2048(b31, b31.label)
    if (b32.style == 'PRIMARY') setNumber2048(b32, b32.label)
    if (b33.style == 'PRIMARY') setNumber2048(b33, b33.label)
}

async function comprobarFinJuego(button, b00, b01, b02, b03, b10, b11, b12, b13, b20, b21, b22, b23, b30, b31, b32, b33, message2) {
    const valores = [
        [b00.customId.split('_')[3], b01.customId.split('_')[3], b02.customId.split('_')[3], b03.customId.split('_')[3]],
        [b10.customId.split('_')[3], b11.customId.split('_')[3], b12.customId.split('_')[3], b13.customId.split('_')[3]],
        [b20.customId.split('_')[3], b21.customId.split('_')[3], b22.customId.split('_')[3], b23.customId.split('_')[3]],
        [b30.customId.split('_')[3], b31.customId.split('_')[3], b32.customId.split('_')[3], b33.customId.split('_')[3]]
    ];
