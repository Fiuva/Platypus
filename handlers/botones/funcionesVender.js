    ...
    switch (id[1]) {
        case 'anillo':
            ...
            if (userInteraction[0].anillo > 0) {
                ...
                button.reply(`${authorInteraction.user} has ganado ${calcularPrecioVenta(PRECIO.ANILLO)} ${NOMBRE_MONEDAS} vendiendo un anillo`);
            } else {
        ...
        case 'musica-pro':
            if (authorInteraction.roles.cache.has(ROL.MUSICA_PRO)) {
                ...
                button.reply(`${authorInteraction.user} has ganado ${calcularPrecioVenta(PRECIO.MUSICA_PRO)} ${NOMBRE_MONEDAS} vendiendo el rol de música`);
            } else {
        ...
        case 'millonario':
            if (authorInteraction.roles.cache.has(ROL.MILLONARIO)) {
                ...
                button.reply(`${authorInteraction.user} has ganado ${calcularPrecioVenta(PRECIO.MILLONARIO)} ${NOMBRE_MONEDAS} vendiendo tu rol de millonario`);
            } else {
